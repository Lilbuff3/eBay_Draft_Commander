...
Pricing/guardrails (optional): `ACTIVE_TO_SOLD_FACTOR` (0.87), `PRICE_AGREEMENT_RATIO` (1.6 — comps-vs-AI conflict threshold), `PRICE_REVIEW_THRESHOLD` (150.0), `PRICE_COMP_MULTIPLE` (3.0), `DUP_HASH_DISTANCE` (6), `DUP_LOOKBACK_DAYS` (30)
