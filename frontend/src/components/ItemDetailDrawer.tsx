...
import { ChevronDown, ChevronUp, AlertCircle, Loader2, Check } from 'lucide-react'
...
import type { Job, JobDetails, ItemDraft } from '@/lib/api'
                                    ...
                                    <div className="grid grid-cols-1 gap-2">
                                        {Object.entries(draft.itemSpecifics).map(([key, value]) => (
                                            <div key={key} className="flex gap-2 items-center">
                                                <span className="text-xs font-medium text-stone-500 w-24 flex-shrink-0 truncate">{key}:</span>
                                                <Input
                                                    value={value}
                                                    onChange={(e) => {
                                                    ...
                                                    className="h-8 py-0 px-2 text-sm bg-stone-50 border-stone-200 focus:bg-white"
                                                />
                                            </div>
                                        ))}
                                        {/* Add field? For now let's just allow editing existing */}
                                    </div>
                                </div>
