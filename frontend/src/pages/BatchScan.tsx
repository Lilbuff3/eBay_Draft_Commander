            ...
            <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                        ...
                        <Button variant="ghost" size="icon" className="h-8 w-8 flex-shrink-0" onClick={onRemove} aria-label="Remove item">
                        ...
                        <TableBody>
                            ...
                            {items.map((item) => (
                                <TableRow key={item.id} className={item.id === lastScannedId ? "bg-blue-50/50" : ""}>
                                    ...
                                    <TableCell>
                                        <Button variant="ghost" size="icon" onClick={() => dispatch({ type: 'REMOVE_ITEM', payload: item.id })} aria-label="Remove item">
