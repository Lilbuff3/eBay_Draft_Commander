            ...
            <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                        ...
                        <Button variant="ghost" size="icon" aria-label="Remove item" className="h-8 w-8 flex-shrink-0 hover:bg-rose-50 text-stone-500 hover:text-rose-600" onClick={onRemove}>
                            <Trash2 size={14} />
                        </Button>
                    </div>
                </div>
                                ...
                                <TableRow key={item.id} className={cn("border-b border-stone-200 transition-colors hover:bg-stone-100", item.id === lastScannedId ? "bg-persimmon-50" : "")}>
                                    ...
                                    <TableCell>
                                        <div className="flex items-center">
                                            ...
                                            />
                                            <Button variant="ghost" size="icon" aria-label={`Remove ${item.title || item.isbn}`} className="hover:bg-rose-50 text-stone-500 hover:text-rose-600" onClick={() => dispatch({ type: 'REMOVE_ITEM', payload: item.id })}>
                                                <Trash2 size={16} />
                                            </Button>
                                        </div>
                                    </TableCell>
